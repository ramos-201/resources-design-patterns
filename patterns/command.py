...
solicitudes, retrasar o poner en cola la ejecución de una solicitud y soportar operaciones que no se pueden realizar.
"""
...
class Created(ICommand):
    def execute(self) -> 'Task': ...


class Updated(ICommand):
    def execute(self) -> 'Task': ...
